...
<svg xmlns="http://www.w3.org/2000/svg" width="120" height="100" fill="none">
    <path fill="#020F66" fill-rule="evenodd"
        ...
        clip-rule="evenodd" />
    <path fill="#10949D" fill-rule="evenodd"
        ...
        clip-rule="evenodd" />
    <circle cx="41.23" cy="36.789" r="2.248" fill="#10949D" />
    <circle cx="56.22" cy="36.789" r="2.248" fill="#10949D" />
    <circle cx="71.209" cy="36.789" r="2.248" fill="#10949D" />
    <circle cx="48.725" cy="36.789" r="2.248" fill="#10949D" />
    <circle cx="63.715" cy="36.789" r="2.248" fill="#10949D" />
    <circle cx="78.704" cy="36.789" r="2.248" fill="#10949D" />
</svg>
`;
